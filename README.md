...
[![Linkdin Badge](https://img.shields.io/badge/LinkdIn-398af3?logo=logmein&logoColor=white)](https://www.linkedin.com/in/%EC%A3%BC%ED%9B%88-%EC%9D%B4-849888310/)
...
- [YepBuddy - (4) 헬스장 데이터를 불러보자! Supabase REST API를 직접 구성해봤다](https://whdjh.github.io/dev/2025-10-02-yepbuddy-supabase-rest-api.html)<br>
- [YepBuddy - (5) 매일 아침 8시, 나 대신 프로틴 가격을 긁어오는 봇을 만들었다](https://whdjh.github.io/dev/2025-10-03-yepbuddy-protein-price-bot.html)<br>
- [YepBuddy - (6) 도메인은 샀는데 어떻게 적용하지?](https://whdjh.github.io/dev/2025-10-10-yepbuddy-domain-setup.html)<br>
...
- [다국어 리소스 자동 업데이트 (PoC 5편)](https://whdjh.github.io/pages/2025-12-11-i18n-resource-auto-update/)<br>
- [다국어 리소스 관리 하드코딩 API 및 PR 생성 워크플로우 검증 (PoC 6편)](https://whdjh.github.io/pages/2025-12-16-i18n-hardcoding-api-pr-workflow/)<br>
...
- TailwindCSS, Styled-Component, Module.css
