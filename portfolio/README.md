...
![자연어 기반 백오피스 AI 커맨드 봇 아키텍처](./career/ai-command/assets/architecture.png)
...
![레거시 웹과 신규 웹의 점진적 라우팅 아키텍처](./career/routing-branch/assets/final-routing.png)
...
![GitHub Actions 기반 다국어 리소스 관리 아키텍처](./career/i18n-automation/assets/i18n-architecture.png)
...
![옙버디 아키텍처](./side-projects/assets/yepbuddy-architecture.png)
